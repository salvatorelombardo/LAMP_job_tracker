...
ac.viewDelAssetsTableFunctions = function (e) {
	...
	if (e.target.nodeName.toLowerCase() == 'a') {
		...
		Util.msgBox({
			...
			body: {
				text: 'You are about to delete this asset. It will not be recoverable. If this is what you want to do click "Ok" Otherwise click "Cancel"'
			},
			leftbtn: {
				text: 'Okay',
				background: 'green',
...
ac.addAssetToAccount = function () {
	...
	data.elements = [{
			id: 'name',
			regex: 'name',
			msg: 'Name cannot be blank and must have a valid name',
...
ac.addaccount = function () {
	...
	data.elements = [{
			regex: 'name',
			id: 'name',
			msg: 'Name cannot be empty and must be a valid name',
			status: 'checking',
			duplicate: true
		},
		{
			regex: 'address',
			id: 'address',
			msg: 'Address cannot be empty and must be a valid address',
			status: 'checking'
		},
		{
			regex: 'city',
			id: 'city',
			msg: 'City cannot be empty and must be a valid city',
			status: 'checking'
		},
		{
			regex: 'state',
			id: 'state',
			msg: 'State must be a two letter uppercase abbreviation',
			status: 'checking'
		},
		{
			regex: 'zip',
